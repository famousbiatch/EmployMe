...
public class CustomAdapterMyApplications extends BaseAdapter implements OnClickListener {
    ...
    public CustomAdapterMyApplications(Activity a, ArrayList d, Resources resLocal) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else
        {
            ...
            vi.setOnClickListener(new CustomAdapterMyApplications.OnItemClickListener(position));
        }
        return vi;
    }
    ...
    private class OnItemClickListener  implements OnClickListener{
        ...
        public void onClick(View arg0) {
            ...
            MyApplicationsActivity sct = (MyApplicationsActivity) activity;
