...
public class CustomAdapterFavorites extends BaseAdapter implements OnClickListener {
    ...
    public CustomAdapterFavorites(Activity a, ArrayList d, Resources resLocal) {
            ...
            try {
                ...
                FirebaseStorage.getInstance().getReference().child("BusinessLogos/" + tempValues.getBusinessName()).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Picasso.with(activity).load(uri).placeholder(R.drawable.ic_refresh).error(R.drawable.ic_refresh).fit().into(holder.image);
                    }
    ...
    private class OnItemClickListener  implements OnClickListener{
        ...
        public void onClick(View arg0) {
            ...
            FavoritesActivity sct = (FavoritesActivity) activity;
